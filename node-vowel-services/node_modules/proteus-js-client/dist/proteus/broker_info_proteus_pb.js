...
var BrokerInfoServiceClient = function () {
  ...
  BrokerInfoServiceClient.prototype.brokers = function brokers(message, metadata) {
    ...
    var map = {};
    return this.brokersTrace(map)(new rsocket_flowable.Flowable(function (subscriber) {
  ...
  BrokerInfoServiceClient.prototype.groups = function groups(message, metadata) {
    ...
    var map = {};
    return this.groupsTrace(map)(new rsocket_flowable.Flowable(function (subscriber) {
      var dataBuf = Buffer.from(message.serializeBinary());
      var tracingMetadata = proteus_tracing.mapToBuffer(map);
  ...
  BrokerInfoServiceClient.prototype.destinations = function destinations(message, metadata) {
    ...
    var map = {};
    return this.destinationsTrace(map)(new rsocket_flowable.Flowable(function (subscriber) {
      var dataBuf = Buffer.from(message.serializeBinary());
      var tracingMetadata = proteus_tracing.mapToBuffer(map);
  ...
  BrokerInfoServiceClient.prototype.destinationsByBrokerAndGroup = function destinationsByBrokerAndGroup(message, metadata) {
    ...
    var map = {};
    return this.destinationsByBrokerAndGroupTrace(map)(new rsocket_flowable.Flowable(function (subscriber) {
      var dataBuf = Buffer.from(message.serializeBinary());
      var tracingMetadata = proteus_tracing.mapToBuffer(map);
  ...
  BrokerInfoServiceClient.prototype.destinationsByGroup = function destinationsByGroup(message, metadata) {
    ...
    var map = {};
    return this.destinationsByGroupTrace(map)(new rsocket_flowable.Flowable(function (subscriber) {
      var dataBuf = Buffer.from(message.serializeBinary());
      var tracingMetadata = proteus_tracing.mapToBuffer(map);
  ...
  BrokerInfoServiceClient.prototype.brokersWithGroup = function brokersWithGroup(message, metadata) {
    ...
    var map = {};
    return this.brokersWithGroupTrace(map)(new rsocket_flowable.Flowable(function (subscriber) {
      var dataBuf = Buffer.from(message.serializeBinary());
      var tracingMetadata = proteus_tracing.mapToBuffer(map);
  ...
  BrokerInfoServiceClient.prototype.brokerWithDestination = function brokerWithDestination(message, metadata) {
    ...
    var map = {};
    return this.brokerWithDestinationTrace(map)(new rsocket_flowable.Single(function (subscriber) {
      var dataBuf = Buffer.from(message.serializeBinary());
      var tracingMetadata = proteus_tracing.mapToBuffer(map);
  ...
  BrokerInfoServiceClient.prototype.streamGroupEvents = function streamGroupEvents(message, metadata) {
    ...
    var map = {};
    return this.streamGroupEventsTrace(map)(new rsocket_flowable.Flowable(function (subscriber) {
      var dataBuf = Buffer.from(message.serializeBinary());
      var tracingMetadata = proteus_tracing.mapToBuffer(map);
  ...
  BrokerInfoServiceClient.prototype.streamDestinationEvents = function streamDestinationEvents(message, metadata) {
    ...
    var map = {};
    return this.streamDestinationEventsTrace(map)(new rsocket_flowable.Flowable(function (subscriber) {
      var dataBuf = Buffer.from(message.serializeBinary());
      var tracingMetadata = proteus_tracing.mapToBuffer(map);
  ...
  BrokerInfoServiceClient.prototype.streamBrokerEvents = function streamBrokerEvents(message, metadata) {
    ...
    var map = {};
    return this.streamBrokerEventsTrace(map)(new rsocket_flowable.Flowable(function (subscriber) {
      var dataBuf = Buffer.from(message.serializeBinary());
      var tracingMetadata = proteus_tracing.mapToBuffer(map);
...
var BrokerInfoServiceServer = function () {
    ...
    try {
      ...
      switch (method) {
        case 'BrokerWithDestination':
          return this.brokerWithDestinationTrace(spanContext)(this._service.brokerWithDestination(proteus_broker_info_pb.Destination.deserializeBinary(payload.data), payload.metadata).map(function (message) {
            return {
  ...
  BrokerInfoServiceServer.prototype.requestStream = function requestStream(payload) {
    try {
      ...
      switch (method) {
        case 'Brokers':
          return this.brokersTrace(spanContext)(this._service.brokers(google_protobuf_empty_pb.Empty.deserializeBinary(payload.data), payload.metadata).map(function (message) {
            return {
              data: Buffer.from(message.serializeBinary()),
              metadata: Buffer.alloc(0)
            };
        ...
        case 'Groups':
          return this.groupsTrace(spanContext)(this._service.groups(proteus_broker_info_pb.Broker.deserializeBinary(payload.data), payload.metadata).map(function (message) {
            return {
              data: Buffer.from(message.serializeBinary()),
              metadata: Buffer.alloc(0)
            };
        ...
        case 'Destinations':
          return this.destinationsTrace(spanContext)(this._service.destinations(proteus_broker_info_pb.Broker.deserializeBinary(payload.data), payload.metadata).map(function (message) {
            return {
              data: Buffer.from(message.serializeBinary()),
              metadata: Buffer.alloc(0)
            };
        ...
        case 'DestinationsByBrokerAndGroup':
          return this.destinationsByBrokerAndGroupTrace(spanContext)(this._service.destinationsByBrokerAndGroup(proteus_broker_info_pb.Group.deserializeBinary(payload.data), payload.metadata).map(function (message) {
            return {
              data: Buffer.from(message.serializeBinary()),
              metadata: Buffer.alloc(0)
            };
        ...
        case 'DestinationsByGroup':
          return this.destinationsByGroupTrace(spanContext)(this._service.destinationsByGroup(proteus_broker_info_pb.Group.deserializeBinary(payload.data), payload.metadata).map(function (message) {
            return {
              data: Buffer.from(message.serializeBinary()),
              metadata: Buffer.alloc(0)
            };
        ...
        case 'BrokersWithGroup':
          return this.brokersWithGroupTrace(spanContext)(this._service.brokersWithGroup(proteus_broker_info_pb.Group.deserializeBinary(payload.data), payload.metadata).map(function (message) {
            return {
              data: Buffer.from(message.serializeBinary()),
              metadata: Buffer.alloc(0)
            };
        ...
        case 'streamGroupEvents':
          return this.streamGroupEventsTrace(spanContext)(this._service.streamGroupEvents(proteus_broker_info_pb.Group.deserializeBinary(payload.data), payload.metadata).map(function (message) {
            return {
              data: Buffer.from(message.serializeBinary()),
              metadata: Buffer.alloc(0)
            };
        ...
        case 'streamDestinationEvents':
          return this.streamDestinationEventsTrace(spanContext)(this._service.streamDestinationEvents(proteus_broker_info_pb.Destination.deserializeBinary(payload.data), payload.metadata).map(function (message) {
            return {
              data: Buffer.from(message.serializeBinary()),
              metadata: Buffer.alloc(0)
            };
        ...
        case 'streamBrokerEvents':
          return this.streamBrokerEventsTrace(spanContext)(this._service.streamBrokerEvents(google_protobuf_empty_pb.Empty.deserializeBinary(payload.data), payload.metadata).map(function (message) {
            return {
              data: Buffer.from(message.serializeBinary()),
              metadata: Buffer.alloc(0)
            };
