...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.zipkin.proto3.Span.toObject = function (includeInstance, msg) {
    var f,
      ...
      annotationsList: jspb.Message.toObjectList(msg.getAnnotationsList(), proto.zipkin.proto3.Annotation.toObject, includeInstance),
...
proto.zipkin.proto3.Span.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(8, f, proto.zipkin.proto3.Endpoint.serializeBinaryToWriter);
  }
  f = message.getRemoteEndpoint();
  if (f != null) {
    writer.writeMessage(9, f, proto.zipkin.proto3.Endpoint.serializeBinaryToWriter);
  }
  f = message.getAnnotationsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(10, f, proto.zipkin.proto3.Annotation.serializeBinaryToWriter);
  }
...
proto.zipkin.proto3.Span.prototype.getLocalEndpoint = function () {
  return (/** @type{?proto.zipkin.proto3.Endpoint} */jspb.Message.getWrapperField(this, proto.zipkin.proto3.Endpoint, 8)
  );
};
...
proto.zipkin.proto3.Span.prototype.getRemoteEndpoint = function () {
  return (/** @type{?proto.zipkin.proto3.Endpoint} */jspb.Message.getWrapperField(this, proto.zipkin.proto3.Endpoint, 9)
  );
};
...
proto.zipkin.proto3.Span.prototype.getAnnotationsList = function () {
  return (/** @type{!Array<!proto.zipkin.proto3.Annotation>} */jspb.Message.getRepeatedWrapperField(this, proto.zipkin.proto3.Annotation, 10)
  );
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.zipkin.proto3.ListOfSpans.toObject = function (includeInstance, msg) {
    var f,
        obj = {
      spansList: jspb.Message.toObjectList(msg.getSpansList(), proto.zipkin.proto3.Span.toObject, includeInstance)
    };
...
proto.zipkin.proto3.ListOfSpans.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(1, f, proto.zipkin.proto3.Span.serializeBinaryToWriter);
  }
};
...
proto.zipkin.proto3.ListOfSpans.prototype.getSpansList = function () {
  return (/** @type{!Array<!proto.zipkin.proto3.Span>} */jspb.Message.getRepeatedWrapperField(this, proto.zipkin.proto3.Span, 1)
  );
};
