...
var index = createCommonjsModule(function(module, exports) {
  ...
  function base64Slice(buf, start, end) {
    if (start === 0 && end === buf.length) {
      return index$2.fromByteArray(buf);
    } else {
      return index$2.fromByteArray(buf.slice(start, end));
    }
  }
  ...
  Buffer.prototype.readFloatLE = function readFloatLE(offset, noAssert) {
    offset = offset >>> 0;
    if (!noAssert) checkOffset(offset, 4, this.length);
    return index$4.read(this, offset, true, 23, 4);
  };

  Buffer.prototype.readFloatBE = function readFloatBE(offset, noAssert) {
    offset = offset >>> 0;
    if (!noAssert) checkOffset(offset, 4, this.length);
    return index$4.read(this, offset, false, 23, 4);
  };

  Buffer.prototype.readDoubleLE = function readDoubleLE(offset, noAssert) {
    offset = offset >>> 0;
    if (!noAssert) checkOffset(offset, 8, this.length);
    return index$4.read(this, offset, true, 52, 8);
  };

  Buffer.prototype.readDoubleBE = function readDoubleBE(offset, noAssert) {
    offset = offset >>> 0;
    if (!noAssert) checkOffset(offset, 8, this.length);
    return index$4.read(this, offset, false, 52, 8);
  };
  ...
  function writeFloat(buf, value, offset, littleEndian, noAssert) {
    ...
    index$4.write(buf, value, offset, littleEndian, 23, 4);
    return offset + 4;
  }
  ...
  function writeDouble(buf, value, offset, littleEndian, noAssert) {
    ...
    index$4.write(buf, value, offset, littleEndian, 52, 8);
    return offset + 8;
  }
  ...
  function base64ToBytes(str) {
    return index$2.toByteArray(base64clean(str));
  }
...
const JsonSerializer = {
  deserialize: data => {
    ...
    if (data == null) {
      ...
      str = data;
    } else if (index_1.isBuffer(data)) {
      const buffer = data;
      str = buffer.toString('utf8');
    } else {
      const buffer = index_1.from(data);
      str = buffer.toString('utf8');
    }
...
function byteLength$1(data, encoding) {
  ...
  return index_1.byteLength(data, encoding);
}
...
function toBuffer(data) {
  ...
  return index_1.from(data);
}

/**
     * Function to create a buffer of a given sized filled with zeros.
     */
const createBuffer = typeof index_1.alloc === 'function'
  ? length => index_1.alloc(length)
  : length => new index_1(length).fill(0);
