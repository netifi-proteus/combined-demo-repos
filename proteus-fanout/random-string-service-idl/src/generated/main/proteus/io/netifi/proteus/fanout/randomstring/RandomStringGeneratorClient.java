...
public final class RandomStringGeneratorClient implements RandomStringGenerator {
  ...
  private final java.util.function.Function<java.util.Map<String, String>, java.util.function.Function<? super org.reactivestreams.Publisher<io.netifi.proteus.fanout.randomstring.RandomStringResponse>, ? extends org.reactivestreams.Publisher<io.netifi.proteus.fanout.randomstring.RandomStringResponse>>> generateStringTrace;
  ...
  public RandomStringGeneratorClient(io.rsocket.RSocket rSocket) {
    ...
    this.generateStringTrace = io.netifi.proteus.tracing.ProteusTracing.trace();
  }
  ...
  public RandomStringGeneratorClient(io.rsocket.RSocket rSocket, io.opentracing.Tracer tracer) {
    this.rSocket = rSocket;
    this.generateString = java.util.function.Function.identity();
    this.generateStringTrace = io.netifi.proteus.tracing.ProteusTracing.trace(tracer, RandomStringGenerator.METHOD_GENERATE_STRING, io.netifi.proteus.tracing.Tag.of("proteus.service", RandomStringGenerator.SERVICE), io.netifi.proteus.tracing.Tag.of("proteus.type", "client"), io.netifi.proteus.tracing.Tag.of("proteus.version", "0.8.5"));
  }


  public RandomStringGeneratorClient(io.rsocket.RSocket rSocket, io.micrometer.core.instrument.MeterRegistry registry, io.opentracing.Tracer tracer) {
    this.rSocket = rSocket;
    this.generateString = io.netifi.proteus.metrics.ProteusMetrics.timed(registry, "proteus.client", "service", RandomStringGenerator.SERVICE, "method", RandomStringGenerator.METHOD_GENERATE_STRING);
    this.generateStringTrace = io.netifi.proteus.tracing.ProteusTracing.trace(tracer, RandomStringGenerator.METHOD_GENERATE_STRING, io.netifi.proteus.tracing.Tag.of("proteus.service", RandomStringGenerator.SERVICE), io.netifi.proteus.tracing.Tag.of("proteus.type", "client"), io.netifi.proteus.tracing.Tag.of("proteus.version", "0.8.5"));
  }
  ...
  java.util.Map<String, String> map = new java.util.HashMap<>();
    return reactor.core.publisher.Flux.defer(new java.util.function.Supplier<reactor.core.publisher.Flux<io.rsocket.Payload>>() {
      ...
      public reactor.core.publisher.Flux<io.rsocket.Payload> get() {
        ...
        final io.netty.buffer.ByteBuf metadataBuf = io.netifi.proteus.frames.ProteusMetadata.encode(io.netty.buffer.ByteBufAllocator.DEFAULT, RandomStringGenerator.SERVICE, RandomStringGenerator.METHOD_GENERATE_STRING, tracingMetadata, metadata);
    ...
    }).map(deserializer(io.netifi.proteus.fanout.randomstring.RandomStringResponse.parser())).transform(generateString).transform(generateStringTrace.apply(map));
  }
