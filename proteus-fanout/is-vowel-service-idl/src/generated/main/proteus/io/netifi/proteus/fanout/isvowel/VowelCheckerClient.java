...
public final class VowelCheckerClient implements VowelChecker {
  ...
  private final java.util.function.Function<java.util.Map<String, String>, java.util.function.Function<? super org.reactivestreams.Publisher<io.netifi.proteus.fanout.isvowel.IsVowelResponse>, ? extends org.reactivestreams.Publisher<io.netifi.proteus.fanout.isvowel.IsVowelResponse>>> isVowelTrace;

  public VowelCheckerClient(io.rsocket.RSocket rSocket) {
    this.rSocket = rSocket;
    this.isVowel = java.util.function.Function.identity();
    this.isVowelTrace = io.netifi.proteus.tracing.ProteusTracing.trace();
  }
  ...
  public VowelCheckerClient(io.rsocket.RSocket rSocket, io.opentracing.Tracer tracer) {
    this.rSocket = rSocket;
    this.isVowel = java.util.function.Function.identity();
    this.isVowelTrace = io.netifi.proteus.tracing.ProteusTracing.trace(tracer, VowelChecker.METHOD_IS_VOWEL, io.netifi.proteus.tracing.Tag.of("proteus.service", VowelChecker.SERVICE), io.netifi.proteus.tracing.Tag.of("proteus.type", "client"), io.netifi.proteus.tracing.Tag.of("proteus.version", "0.8.5"));
  }


  public VowelCheckerClient(io.rsocket.RSocket rSocket, io.micrometer.core.instrument.MeterRegistry registry, io.opentracing.Tracer tracer) {
    this.rSocket = rSocket;
    this.isVowel = io.netifi.proteus.metrics.ProteusMetrics.timed(registry, "proteus.client", "service", VowelChecker.SERVICE, "method", VowelChecker.METHOD_IS_VOWEL);
    this.isVowelTrace = io.netifi.proteus.tracing.ProteusTracing.trace(tracer, VowelChecker.METHOD_IS_VOWEL, io.netifi.proteus.tracing.Tag.of("proteus.service", VowelChecker.SERVICE), io.netifi.proteus.tracing.Tag.of("proteus.type", "client"), io.netifi.proteus.tracing.Tag.of("proteus.version", "0.8.5"));
  }
  ...
  java.util.Map<String, String> map = new java.util.HashMap<>();
    return reactor.core.publisher.Mono.defer(new java.util.function.Supplier<reactor.core.publisher.Mono<io.rsocket.Payload>>() {
      ...
      public reactor.core.publisher.Mono<io.rsocket.Payload> get() {
        ...
        final io.netty.buffer.ByteBuf metadataBuf = io.netifi.proteus.frames.ProteusMetadata.encode(io.netty.buffer.ByteBufAllocator.DEFAULT, VowelChecker.SERVICE, VowelChecker.METHOD_IS_VOWEL, tracingMetadata, metadata);
    ...
    }).map(deserializer(io.netifi.proteus.fanout.isvowel.IsVowelResponse.parser())).transform(isVowel).transform(isVowelTrace.apply(map));
  }
