...
var AccessKeyInfoServiceClient = function () {
  ...
  AccessKeyInfoServiceClient.prototype.addAccessKey = function addAccessKey(message, metadata) {
    ...
    var map = {};
    return this.addAccessKeyTrace(map)(new rsocket_flowable.Single(function (subscriber) {
  ...
  AccessKeyInfoServiceClient.prototype.removeAccessKey = function removeAccessKey(message, metadata) {
    ...
    var map = {};
    return this.removeAccessKeyTrace(map)(new rsocket_flowable.Single(function (subscriber) {
      var dataBuf = Buffer.from(message.serializeBinary());
      var tracingMetadata = proteus_tracing.mapToBuffer(map);
  ...
  AccessKeyInfoServiceClient.prototype.disableAccessKey = function disableAccessKey(message, metadata) {
    ...
    var map = {};
    return this.disableAccessKeyTrace(map)(new rsocket_flowable.Single(function (subscriber) {
      var dataBuf = Buffer.from(message.serializeBinary());
      var tracingMetadata = proteus_tracing.mapToBuffer(map);
  ...
  AccessKeyInfoServiceClient.prototype.enableAccessKey = function enableAccessKey(message, metadata) {
    ...
    var map = {};
    return this.enableAccessKeyTrace(map)(new rsocket_flowable.Single(function (subscriber) {
      var dataBuf = Buffer.from(message.serializeBinary());
      var tracingMetadata = proteus_tracing.mapToBuffer(map);
  ...
  AccessKeyInfoServiceClient.prototype.getAccessKey = function getAccessKey(message, metadata) {
    ...
    var map = {};
    return this.getAccessKeyTrace(map)(new rsocket_flowable.Single(function (subscriber) {
      var dataBuf = Buffer.from(message.serializeBinary());
      var tracingMetadata = proteus_tracing.mapToBuffer(map);
  ...
  AccessKeyInfoServiceClient.prototype.getAccessKeys = function getAccessKeys(message, metadata) {
    ...
    var map = {};
    return this.getAccessKeysTrace(map)(new rsocket_flowable.Flowable(function (subscriber) {
      var dataBuf = Buffer.from(message.serializeBinary());
      var tracingMetadata = proteus_tracing.mapToBuffer(map);
...
var AccessKeyInfoServiceServer = function () {
  ...
  AccessKeyInfoServiceServer.prototype.requestResponse = function requestResponse(payload) {
    try {
      ...
      switch (method) {
        case 'AddAccessKey':
          return this.addAccessKeyTrace(spanContext)(this._service.addAccessKey(proteus_accesskey_info_pb.AccessToken.deserializeBinary(payload.data), payload.metadata).map(function (message) {
            return {
        ...
        case 'RemoveAccessKey':
          return this.removeAccessKeyTrace(spanContext)(this._service.removeAccessKey(proteus_accesskey_info_pb.AccessKey.deserializeBinary(payload.data), payload.metadata).map(function (message) {
            return {
              data: Buffer.from(message.serializeBinary()),
              metadata: Buffer.alloc(0)
            };
        ...
        case 'DisableAccessKey':
          return this.disableAccessKeyTrace(spanContext)(this._service.disableAccessKey(proteus_accesskey_info_pb.AccessKey.deserializeBinary(payload.data), payload.metadata).map(function (message) {
            return {
              data: Buffer.from(message.serializeBinary()),
              metadata: Buffer.alloc(0)
            };
        ...
        case 'EnableAccessKey':
          return this.enableAccessKeyTrace(spanContext)(this._service.enableAccessKey(proteus_accesskey_info_pb.AccessKey.deserializeBinary(payload.data), payload.metadata).map(function (message) {
            return {
              data: Buffer.from(message.serializeBinary()),
              metadata: Buffer.alloc(0)
            };
        ...
        case 'GetAccessKey':
          return this.getAccessKeyTrace(spanContext)(this._service.getAccessKey(proteus_accesskey_info_pb.AccessKey.deserializeBinary(payload.data), payload.metadata).map(function (message) {
            return {
              data: Buffer.from(message.serializeBinary()),
              metadata: Buffer.alloc(0)
            };
  ...
  AccessKeyInfoServiceServer.prototype.requestStream = function requestStream(payload) {
    try {
      ...
      switch (method) {
        case 'GetAccessKeys':
          return this.getAccessKeysTrace(spanContext)(this._service.getAccessKeys(google_protobuf_empty_pb.Empty.deserializeBinary(payload.data), payload.metadata).map(function (message) {
            return {
              data: Buffer.from(message.serializeBinary()),
              metadata: Buffer.alloc(0)
            };
