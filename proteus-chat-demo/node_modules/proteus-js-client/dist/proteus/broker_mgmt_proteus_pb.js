...
var BrokerManagementServiceClient = function () {
  ...
  BrokerManagementServiceClient.prototype.leave = function leave(message, metadata) {
    ...
    var map = {};
    return this.leaveTrace(map)(new rsocket_flowable.Single(function (subscriber) {
      var dataBuf = Buffer.from(message.serializeBinary());
      var tracingMetadata = proteus_tracing.mapToBuffer(map);
  ...
  BrokerManagementServiceClient.prototype.rejoin = function rejoin(message, metadata) {
    ...
    var map = {};
    return this.rejoinTrace(map)(new rsocket_flowable.Single(function (subscriber) {
      var dataBuf = Buffer.from(message.serializeBinary());
      var tracingMetadata = proteus_tracing.mapToBuffer(map);
  ...
  BrokerManagementServiceClient.prototype.join = function join(message, metadata) {
    ...
    var map = {};
    return this.joinTrace(map)(new rsocket_flowable.Single(function (subscriber) {
      var dataBuf = Buffer.from(message.serializeBinary());
      var tracingMetadata = proteus_tracing.mapToBuffer(map);
  ...
  BrokerManagementServiceClient.prototype.closeDestination = function closeDestination(messages, metadata) {
    ...
    var once = false;
    var map = {};
    return this.closeDestinationTrace(map)(new rsocket_flowable.Flowable(function (subscriber) {
      var dataBuf = Buffer.from(message.serializeBinary());
      var tracingMetadata = proteus_tracing.mapToBuffer(map);
      ...
      _this4._rs.requestChannel(messages.map(function (message) {
        var dataBuf = Buffer.from(message.serializeBinary());
        if (!once) {
          once = true;
  ...
  BrokerManagementServiceClient.prototype.closeGroup = function closeGroup(messages, metadata) {
    ...
    var once = false;
    var map = {};
    return this.closeGroupTrace(map)(new rsocket_flowable.Flowable(function (subscriber) {
      var dataBuf = Buffer.from(message.serializeBinary());
      var tracingMetadata = proteus_tracing.mapToBuffer(map);
  ...
  BrokerManagementServiceClient.prototype.closeBroker = function closeBroker(messages, metadata) {
    ...
    var once = false;
    var map = {};
    return this.closeBrokerTrace(map)(new rsocket_flowable.Flowable(function (subscriber) {
      var dataBuf = Buffer.from(message.serializeBinary());
      var tracingMetadata = proteus_tracing.mapToBuffer(map);
  ...
  BrokerManagementServiceClient.prototype.closeDestinations = function closeDestinations(message, metadata) {
    ...
    var map = {};
    return this.closeDestinationsTrace(map)(new rsocket_flowable.Single(function (subscriber) {
      var dataBuf = Buffer.from(message.serializeBinary());
      var tracingMetadata = proteus_tracing.mapToBuffer(map);
  ...
  BrokerManagementServiceClient.prototype.closeBrokers = function closeBrokers(message, metadata) {
    ...
    var map = {};
    return this.closeBrokersTrace(map)(new rsocket_flowable.Single(function (subscriber) {
      var dataBuf = Buffer.from(message.serializeBinary());
      var tracingMetadata = proteus_tracing.mapToBuffer(map);
  ...
  BrokerManagementServiceClient.prototype.closeAll = function closeAll(message, metadata) {
    ...
    var map = {};
    return this.closeAllTrace(map)(new rsocket_flowable.Single(function (subscriber) {
      var dataBuf = Buffer.from(message.serializeBinary());
      var tracingMetadata = proteus_tracing.mapToBuffer(map);
...
var BrokerManagementServiceServer = function () {
  ...
  BrokerManagementServiceServer.prototype.requestResponse = function requestResponse(payload) {
    try {
      ...
      switch (method) {
        case 'leave':
          return this.leaveTrace(spanContext)(this._service.leave(google_protobuf_empty_pb.Empty.deserializeBinary(payload.data), payload.metadata).map(function (message) {
            return {
        ...
        case 'rejoin':
          return this.rejoinTrace(spanContext)(this._service.rejoin(google_protobuf_empty_pb.Empty.deserializeBinary(payload.data), payload.metadata).map(function (message) {
            return {
              data: Buffer.from(message.serializeBinary()),
              metadata: Buffer.alloc(0)
            };
        ...
        case 'join':
          return this.joinTrace(spanContext)(this._service.join(proteus_broker_mgmt_pb.Brokers.deserializeBinary(payload.data), payload.metadata).map(function (message) {
            return {
              data: Buffer.from(message.serializeBinary()),
              metadata: Buffer.alloc(0)
            };
        ...
        case 'closeDestinations':
          return this.closeDestinationsTrace(spanContext)(this._service.closeDestinations(google_protobuf_empty_pb.Empty.deserializeBinary(payload.data), payload.metadata).map(function (message) {
            return {
              data: Buffer.from(message.serializeBinary()),
              metadata: Buffer.alloc(0)
            };
        ...
        case 'closeBrokers':
          return this.closeBrokersTrace(spanContext)(this._service.closeBrokers(google_protobuf_empty_pb.Empty.deserializeBinary(payload.data), payload.metadata).map(function (message) {
            return {
              data: Buffer.from(message.serializeBinary()),
              metadata: Buffer.alloc(0)
            };
        ...
        case 'closeAll':
          return this.closeAllTrace(spanContext)(this._service.closeAll(google_protobuf_empty_pb.Empty.deserializeBinary(payload.data), payload.metadata).map(function (message) {
            return {
              data: Buffer.from(message.serializeBinary()),
              metadata: Buffer.alloc(0)
            };
