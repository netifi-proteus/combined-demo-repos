...
public class MessageDrivenRandomStringGenerator_old implements RandomStringGenerator, Chat {
    private static final Logger logger = LogManager.getLogger(MessageDrivenRandomStringGenerator_old.class);

    private final ArrayBlockingQueue<String> _buffer;

    public MessageDrivenRandomStringGenerator_old() {
